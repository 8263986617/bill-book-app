    ...
    try {
      ...
      if (bills.length > 0) {
        ...
        bills.forEach((bill) => {
          ...
          months[monthName] = (months[monthName] || 0) + bill.totalAmount;
        });
    ...
    <div className="dashboard-container">
      <div className="dashboard-header">
        <div>
          ...
          <p className="dashboard-subtitle">तुमच्या बिलांची झटपट माहिती</p>
        </div>
        <button className="btn-primary" onClick={() => navigate('/create-bill')}>
          + नवीन बिल
        </button>
      </div>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-value">₹{stats.avgBill.toLocaleString()}</div>
        </div>
      </div>
              ...
              Object.entries(monthlyData).map(([month, amount]) => (
                <div key={month} className="chart-bar-wrapper">
                  <div
                    ...
                    style={{
                      height:
                        (amount / Math.max(...Object.values(monthlyData))) * 300 +
                        "px",
                    }}
                    title={`₹${amount}`}
                  ></div>
      ...
      <div className="recent-bills">
        ...
        {recentBills.length > 0 ? (
          ...
          <p style={{ textAlign: "center", color: "#999" }}>No bills available</p>
        )}
      </div>
    </div>
  );
